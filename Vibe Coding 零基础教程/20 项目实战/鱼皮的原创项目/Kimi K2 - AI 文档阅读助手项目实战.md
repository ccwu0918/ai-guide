...
專案包含完整的前端和後端，全程透過和 AI 對話完成開發，不寫一行程式碼，適合想快速實踐完整 Vibe Coding 開發流程、想學習如何用 AI 開發實用工具的同學。
...
先下載開原始碼到自己電腦，然後直接執行我提供的快速啟動指令碼，開啟網頁就能看到效果了。
...
當你要閱讀文件時，點選 “單個匯入” 按鈕，上傳文件檔案，然後需要填寫 Kimi AI 的 API Key。

![](https://pic.yupi.icu/1/1757560732751-de713284-c039-41c1-b9f4-0af34e4c703c.png)



選擇 Kimi 是因為他們剛剛釋出了新版本的 K2 模型，在程式設計、推理和文件理解方面都很不錯；
...
只需要登入 [Kimi 的開發控制檯](https://platform.moonshot.cn/)，然後進入 API Key 管理來獲取一個呼叫大模型的金鑰。

![](https://pic.yupi.icu/1/1757560312832-cfd4158d-8c31-4c22-8b42-573551334863.png)



雖然新人有免費額度，但是不要洩露自己的金鑰哦！
...
你還可以批次匯入多個文件，同時呼叫 AI 生成閱讀指南，提高效率。

![](https://pic.yupi.icu/1/1757560886812-1706415c-cff5-4475-872f-ba66891563f7.png)



此外，你還可以把這個網站當做自己的智慧文件收藏夾，可以分類檢索已經匯入的文件、下載原始檔案、隨時檢視文件閱讀指南。**不要再讓自己收藏過的文件找不到啦~**
...
首先在終端輸入一行命令來安裝 Claude Code：

```bash
npm install -g @anthropic-ai/claude-code
```

然後執行 `claude` 命令，就可以向它提問了~
...
以上就是本期分享，希望這個工具對大家有幫助，也不要忘記給魚皮三連支援，謝謝大家~
